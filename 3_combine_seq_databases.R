...
search_string <- c(search_string_1, search_string_2, search_string_3)
dada2_matches <- system(command=paste('ls', search_string), intern=TRUE)
collapsed <- paste(dada2_matches, collapse=" ")
system(command=paste("cat", collapsed, "> ~/Documents/Research_Projects/metabarcoding/metaR/ref_files/dada2_ref_db_without_bold.fasta"))
system(command=paste("gzip", "~/Documents/Research_Projects/metabarcoding/metaR/ref_files/dada2_ref_db_without_bold.fasta"))
